combine_weekly_pand_deaths_by_age_and_cause = function(data_all){
  ...
  deaths_pand_pred_sample = rbindlist(deaths_pand_pred_sample)
  
  saveRDS(deaths_pand_pred_sample,file="results/deaths_pand_pred_sample.RDS")
  
  return(deaths_pand_pred_sample)
}