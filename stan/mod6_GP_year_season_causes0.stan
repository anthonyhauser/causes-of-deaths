...
data {
  ...
  array[N_cause] vector[N_all] deaths_all;
...
generated quantities {
  ...
  // {//define variables eta inside brackets so that they are nto saved
    //   array[N_cause] row_vector[N_all] eta_all;
    //   matrix[N_cause,N_all] eta2_all;
    //   for(g in 1:N_cause) {
      //     mu_all[g] = mu0[g] + f_week[g] + f_year[g] + log(n_pop_all[g]);
      //     for(i in 1:N_all){
