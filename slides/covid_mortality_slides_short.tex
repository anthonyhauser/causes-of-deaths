...
%%% 1. THE PUZZLE -- open here, no methods yet %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ~0:50
\begin{frame}{Start with a puzzle}
  \vfill
  \begin{itemize}\compresslist
    \item During the Alpha wave, \punch{cancer deaths in the 80+ fell well below
          expected.}
    \item Mental/neurological mortality fell too: $-12\%$ over 2020--21,
          $-24\%$ during the Alpha wave.
  \end{itemize}
  \vfill
  \begin{center}
    \large Did fewer people really die \emph{of} cancer during a pandemic?
  \end{center}
  \vfill
  \begin{itemize}\compresslist
    \item Single-cause excess mortality cannot answer this ---
          it cannot separate a \emph{real} change in deaths from a
          \emph{reallocation} of deaths between causes.
  \end{itemize}
  \vfill
\end{frame}
...
%%% 2. THE HEADLINE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ~1:40
\begin{frame}{And a headline that needs explaining}
  \begin{columns}[t]
...
% ~4:00
\begin{frame}{What moved, and when}
  \begin{columns}[t]
...
% ~5:20
\begin{frame}{Lags turn pattern into mechanism}
  \begin{columns}[t]
...
%%% 6. PUZZLE RESOLVED %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ~6:10
\begin{frame}{Back to the puzzle: the cancer deficit}
  \vfill
  Resolved with \textbf{multiple-cause-of-death} data:
  \begin{itemize}\compresslist
